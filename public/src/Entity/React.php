...
class React
{
    ...
    public function __construct(string $action, string $entity, array $dados, array $dadosOld = [])
    {
        ...
        if(!preg_match("/^wcache_/i", $entity)) {
            ...
            //use this only if the sseEngineDB is using this
    ...
    /**
     * Cria atualizações para serem sincronizadas com o front
     * o front absorveria somente as alterações aqui informadas,
     * não necessitando fazer o download de conteúdos não alterados
     *
     * @param string $action
     * @param string $entity
     * @param array $dados
